##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.15.2] date: [Mon Dec 27 03:11:40 CET 2021] 
##########################################################################################################################
...
# target
######################################
TARGET = Nucleo_G431RB_Driver_Dev
...
# The g++ compiler bin path can be either defined in make command via g++_PATH variable (> make g++_PATH=xxx)
# either it can be added to the PATH environment variable.
ifdef g++_PATH
CC = $(g++_PATH)/$(PREFIX)g++
AS = $(g++_PATH)/$(PREFIX)g++ -x assembler-with-cpp
CP = $(g++_PATH)/$(PREFIX)objcopy
SZ = $(g++_PATH)/$(PREFIX)size
else
CC = $(PREFIX)g++
