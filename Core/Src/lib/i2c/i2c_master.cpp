...
void I2C_Master::init()
{
	...
	I2C1->TIMINGR |= (0x03 << I2C_TIMINGR_PRESC_Pos) | (0x13 << I2C_TIMINGR_SCLL_Pos) | (0x0F << I2C_TIMINGR_SCLH_Pos) | (0x02 << I2C_TIMINGR_SDADEL_Pos)
			| (0x04 << I2C_TIMINGR_SCLDEL_Pos);

	I2C1->CR1 |= I2C_CR1_PE_Msk;
}
void I2C_Master::write(uint8_t addr, uint8_t* data, uint16_t len, bool repeated_start)
{
...
void I2C_Master::read(uint8_t addr, uint8_t* data, uint16_t len, bool stop_cond)
{
	uint16_t counter = 0;
	I2C1->CR2 &= ~I2C_CR2_SADD_Msk;
	I2C1->CR2 |= addr << (I2C_CR2_SADD_Pos + 1);
